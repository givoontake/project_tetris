...
PACKET_REGISTRY: dict[int, type] = {
    ...
    C2S_REQUEST_FRIEND: C2S_REQUEST_FRIEND_PACKET,
    C2S_DELETE_FRIEND: C2S_DELETE_FRIEND_PACKET,
    C2S_ACCEPT_FRIEND: C2S_ACCEPT_FRIEND_PACKET,

    S2C_REQUEST_FRIEND: S2C_REQUEST_FRIEND_PACKET,
    S2C_DELETE_FRIEND: S2C_DELETE_FRIEND_PACKET,
    S2C_ADD_FRIEND: S2C_ADD_FRIEND_PACKET,

    C2S_REQUEST_LOBBY_USER_LIST: C2S_REQUEST_LOBBY_USER_LIST_PACKET,
    S2C_LOBBY_USER_INFO: S2C_LOBBY_USER_INFO_PACKET,

    C2S_REQUEST_FRIEND_LIST: C2S_REQUEST_FRIEND_LIST_PACKET,
    S2C_FRIEND_INFO: S2C_FRIEND_INFO_PACKET,
    C2S_REQUEST_RANKING: C2S_REQUEST_RANKING_PACKET,
    S2C_RANKING_INFO: S2C_RANKING_INFO_PACKET,
