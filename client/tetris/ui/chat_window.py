...
VISIBLE_LINES = 10
CHAT_SHOW_HEIGHT = LINE_HEIGHT * VISIBLE_LINES

OPTIMIZED_OFFSET = 10
TEXT_START_OFFSET_X = 2
...
class ChatWindow(ScrollWindowBase):
    def __init__(self, screen: pygame.Surface, rect: pygame.Rect, rm: ResourceManager):
        ...
        self.input_box.text_h = FONT_SIZE
        self.input_box.padding = TEXT_START_OFFSET_X
        self.input_box.font = self.rm.fonts.get_font(FONT_SIZE)
        self.font = self.rm.fonts.get_font(FONT_SIZE)

        super().__init__(screen, show_rect, LINE_HEIGHT)
        self.show_lines = VISIBLE_LINES
    ...
    def draw_item(self, i: int, draw_text_y: int):
        ...
        self.screen.blit(text_surf, (self.window_x + TEXT_START_OFFSET_X, draw_text_y))
